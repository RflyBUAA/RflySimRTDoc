...
![图：Pixhawk I2C接口定义](../img/pixhawki2c.png)

![图：Pixhawk GPS接口定义](../img/pixhawkgps.png)

![图：Pixhawk SPI接口定义](../img/pixhawkspi.png)

![图：Pixhawk PWM接口定义](../img/pixhawkpwmout.png)
...
NOTE: 默认支持PX4 v1.11版本的固件。对于v1.12的支持请参考[如何使用PX4 1.12固件](https://www.yuque.com/rflysocfpgahil/lkdltx/goxg0w?view=doc_embed)。区别主要在于启动脚本的修改内容有细微的变化。 
